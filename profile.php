...
<body>
	...
	<!-- HERE INSERT THE LOGIN PAGE IN HREF-->
	  <div id="headerLinks"><a href="#" title="Login/Register">Logout</a></div> 
	</header>
	...
	<div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
		...
		<label for="tab1">Purchase History</label>

		<input type="radio" name="pcss3t" id="tab2" class="tab-content-2">
		<label for="tab2">Tracked Items</label>

		<input type="radio" name="pcss3t" id="tab3" class="tab-content-3">
		<label for="tab3">Favourite Items</label>
		<ul>
			<li class="tab-content tab-content-1 typography">
				<img alt="sample" src="images/200x200.png" align="left" style="margin-right: 20px;">
		   	    <div class="section1Content">
				  <p><span>Product Name :</span> </p>
				  <p><span>Descrition :</span> </p>
